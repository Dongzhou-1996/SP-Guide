...
from main_goal_predictor import _compute_spl
...
if args.mode == 'eval':
    ...
    for split in ('val_seen', 'val_unseen', 'test_unseen'):
        ...
        print(f"{split} -- {metrics.mean_final_pos_to_goal_dist: .1f}, {metrics.success_rate_final_pos_to_goal*100: .2f}, {metrics.success_rate_oracle_pos_to_goal*100: .2f}, {spl*100: .2f}")
