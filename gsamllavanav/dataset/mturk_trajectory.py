...
from gsamllavanav.defaultpaths import MTURK_TRAJECTORY_DIR, get_data_root
...
def load_mturk_trajectories(split: MturkSplit, difficulty: MturkDifficulty, fix_altitude: Optional[float] = None, trajectory_dir=None):
    
    if trajectory_dir is None:
        trajectory_dir = get_data_root() / "citynav"
